...
var snapshotImageCmd = &cobra.Command{
	...
	Long:  `Run itest list-images --distro=ubunt-focal to list images. Grab the BASE image name you want to snapshot from the list, and run this command to create a snapshot.`,
...
func init() {
	...
	snapshotImageCmd.Flags().String("base-image-name", "", "Grab your desired BASE image name from itest list-images and put it here")
